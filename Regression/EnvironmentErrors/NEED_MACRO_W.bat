...
echo options C_DEFINE_LIST VCAST_NO_PTR_TO_UNCON_ARRAY_SUPPORT MAXIMUM_MEMORY_SIZE=100 >> commands.tmp
...
echo environment build NEED_MACRO_W.env >> commands.tmp
echo /E:NEED_MACRO_W tools script run NEED_MACRO_W.tst >> commands.tmp
echo /E:NEED_MACRO_W execute batch >> commands.tmp
echo /E:NEED_MACRO_W reports custom management NEED_MACRO_W_management_report.html >> commands.tmp

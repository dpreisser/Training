...
echo environment build MANA_STUB_PROTO.env >> commands.tmp
echo /E:MANA_STUB_PROTO tools script run MANA_STUB_PROTO.tst >> commands.tmp
echo /E:MANA_STUB_PROTO execute batch >> commands.tmp
echo /E:MANA_STUB_PROTO reports custom management MANA_STUB_PROTO_management_report.html >> commands.tmp

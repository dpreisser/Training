...
echo options VCAST_COVERAGE_FOR_HEADERS TRUE >> commands.tmp
...
echo options VCAST_REPORT_ON_IMPLICIT_DEFAULT_CASE TRUE >> commands.tmp
echo options VCAST_RPTS_DEFAULT_FONT_FACE Arial(8) >> commands.tmp
echo options VCAST_SHOW_INLINES_COVERED_IN_ALL_UNITS TRUE >> commands.tmp
...
echo options VCAST_TEST_ALL_NON_MEMBER_INLINES TRUE >> commands.tmp
...
echo environment build DATE_UTILITIES_W.env >> commands.tmp
echo /E:DATE_UTILITIES_W tools script run DATE_UTILITIES_W.tst >> commands.tmp
echo /E:DATE_UTILITIES_W execute batch >> commands.tmp
echo /E:DATE_UTILITIES_W reports custom management DATE_UTILITIES_W_management_report.html >> commands.tmp

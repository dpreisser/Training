...
echo options VCAST_TEST_ALL_INLINES TRUE >> commands.tmp
...
echo environment build INLINE_W.env >> commands.tmp
echo /E:INLINE_W tools script run INLINE_W.tst >> commands.tmp
echo /E:INLINE_W execute batch >> commands.tmp
echo /E:INLINE_W reports custom management INLINE_W_management_report.html >> commands.tmp

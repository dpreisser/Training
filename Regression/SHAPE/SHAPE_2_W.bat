...
echo environment build SHAPE_2_W.env >> commands.tmp
echo /E:SHAPE_2_W tools script run SHAPE_2_W.tst >> commands.tmp
echo /E:SHAPE_2_W execute batch >> commands.tmp
echo /E:SHAPE_2_W reports custom management SHAPE_2_W_management_report.html >> commands.tmp

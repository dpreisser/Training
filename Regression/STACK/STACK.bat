...
echo environment build STACK.env >> commands.tmp
echo /E:STACK tools script run STACK.tst >> commands.tmp
echo /E:STACK execute batch >> commands.tmp
echo /E:STACK reports custom management STACK_management_report.html >> commands.tmp

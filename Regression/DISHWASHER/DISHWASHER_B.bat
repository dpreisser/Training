...
echo environment build DISHWASHER_B.env >> commands.tmp
echo /E:DISHWASHER_B tools script run DISHWASHER_B.tst >> commands.tmp
echo /E:DISHWASHER_B execute batch >> commands.tmp
echo /E:DISHWASHER_B reports custom management DISHWASHER_B_management_report.html >> commands.tmp

...
echo environment build CONTROL_FLOW_W.env >> commands.tmp
echo /E:CONTROL_FLOW_W tools script run CONTROL_FLOW_W.tst >> commands.tmp
echo /E:CONTROL_FLOW_W execute batch >> commands.tmp
echo /E:CONTROL_FLOW_W reports custom management CONTROL_FLOW_W_management_report.html >> commands.tmp

...
echo environment build MANAGER_W.env >> commands.tmp
echo /E:MANAGER_W tools script run MANAGER_W.tst >> commands.tmp
echo /E:MANAGER_W execute batch >> commands.tmp
echo /E:MANAGER_W reports custom management MANAGER_W_management_report.html >> commands.tmp

...
echo environment build VCAST_TIME_W.env >> commands.tmp
echo /E:VCAST_TIME_W tools script run VCAST_TIME_W.tst >> commands.tmp
echo /E:VCAST_TIME_W execute batch >> commands.tmp
echo /E:VCAST_TIME_W reports custom management VCAST_TIME_W_management_report.html >> commands.tmp

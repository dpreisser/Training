...
echo environment build SHAPE_W.env >> commands.tmp
echo /E:SHAPE_W tools script run SHAPE_W.tst >> commands.tmp
echo /E:SHAPE_W execute batch >> commands.tmp
echo /E:SHAPE_W reports custom management SHAPE_W_management_report.html >> commands.tmp

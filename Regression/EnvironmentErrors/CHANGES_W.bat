...
echo environment build CHANGES_W.env >> commands.tmp
echo /E:CHANGES_W tools script run CHANGES_W.tst >> commands.tmp
echo /E:CHANGES_W execute batch >> commands.tmp
echo /E:CHANGES_W reports custom management CHANGES_W_management_report.html >> commands.tmp

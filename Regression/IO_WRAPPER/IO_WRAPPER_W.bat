...
echo environment build IO_WRAPPER_W.env >> commands.tmp
echo /E:IO_WRAPPER_W tools script run IO_WRAPPER_W.tst >> commands.tmp
echo /E:IO_WRAPPER_W execute batch >> commands.tmp
echo /E:IO_WRAPPER_W reports custom management IO_WRAPPER_W_management_report.html >> commands.tmp

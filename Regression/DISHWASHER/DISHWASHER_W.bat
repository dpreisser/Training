...
echo environment build DISHWASHER_W.env >> commands.tmp
echo /E:DISHWASHER_W tools script run DISHWASHER_W.tst >> commands.tmp
echo /E:DISHWASHER_W execute batch >> commands.tmp
echo /E:DISHWASHER_W reports custom management DISHWASHER_W_management_report.html >> commands.tmp

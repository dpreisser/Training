...
echo environment build COMMUNICATION_W.env >> commands.tmp
echo /E:COMMUNICATION_W tools script run COMMUNICATION_W.tst >> commands.tmp
echo /E:COMMUNICATION_W execute batch >> commands.tmp
echo /E:COMMUNICATION_W reports custom management COMMUNICATION_W_management_report.html >> commands.tmp

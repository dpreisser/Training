...
echo environment build NEED_INCLUDE_W.env >> commands.tmp
echo /E:NEED_INCLUDE_W tools script run NEED_INCLUDE_W.tst >> commands.tmp
echo /E:NEED_INCLUDE_W execute batch >> commands.tmp
echo /E:NEED_INCLUDE_W reports custom management NEED_INCLUDE_W_management_report.html >> commands.tmp

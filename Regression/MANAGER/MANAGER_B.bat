...
echo environment build MANAGER_B.env >> commands.tmp
echo /E:MANAGER_B tools script run MANAGER_B.tst >> commands.tmp
echo /E:MANAGER_B execute batch >> commands.tmp
echo /E:MANAGER_B reports custom management MANAGER_B_management_report.html >> commands.tmp

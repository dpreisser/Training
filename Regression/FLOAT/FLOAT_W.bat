...
echo environment build FLOAT_W.env >> commands.tmp
echo /E:FLOAT_W tools script run FLOAT_W.tst >> commands.tmp
echo /E:FLOAT_W execute batch >> commands.tmp
echo /E:FLOAT_W reports custom management FLOAT_W_management_report.html >> commands.tmp

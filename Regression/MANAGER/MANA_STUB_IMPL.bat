...
echo environment build MANA_STUB_IMPL.env >> commands.tmp
echo /E:MANA_STUB_IMPL tools script run MANA_STUB_IMPL.tst >> commands.tmp
echo /E:MANA_STUB_IMPL execute batch >> commands.tmp
echo /E:MANA_STUB_IMPL reports custom management MANA_STUB_IMPL_management_report.html >> commands.tmp

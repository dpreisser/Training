...
echo environment build MANA_NONE.env >> commands.tmp
echo /E:MANA_NONE tools script run MANA_NONE.tst >> commands.tmp
echo /E:MANA_NONE execute batch >> commands.tmp
echo /E:MANA_NONE reports custom management MANA_NONE_management_report.html >> commands.tmp

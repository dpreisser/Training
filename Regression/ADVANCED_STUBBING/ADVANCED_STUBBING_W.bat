...
echo environment build ADVANCED_STUBBING_W.env >> commands.tmp
echo /E:ADVANCED_STUBBING_W tools script run ADVANCED_STUBBING_W.tst >> commands.tmp
echo /E:ADVANCED_STUBBING_W execute batch >> commands.tmp
echo /E:ADVANCED_STUBBING_W reports custom management ADVANCED_STUBBING_W_management_report.html >> commands.tmp

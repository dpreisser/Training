...
echo environment build LINE_W.env >> commands.tmp
echo /E:LINE_W tools script run LINE_W.tst >> commands.tmp
echo /E:LINE_W execute batch >> commands.tmp
echo /E:LINE_W reports custom management LINE_W_management_report.html >> commands.tmp

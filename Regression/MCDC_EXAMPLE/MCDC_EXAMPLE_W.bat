...
echo environment build MCDC_EXAMPLE_W.env >> commands.tmp
echo /E:MCDC_EXAMPLE_W  tools update mcdc >> commands.tmp
echo /E:MCDC_EXAMPLE_W tools script run MCDC_EXAMPLE_W.tst >> commands.tmp
echo /E:MCDC_EXAMPLE_W execute batch >> commands.tmp
echo /E:MCDC_EXAMPLE_W tools import_coverage MCDC_EXAMPLE_W.cvr >> commands.tmp
echo /E:MCDC_EXAMPLE_W reports custom management MCDC_EXAMPLE_W_management_report.html >> commands.tmp

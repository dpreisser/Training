...
echo environment build MANA_STUB_NONE.env >> commands.tmp
echo /E:MANA_STUB_NONE tools script run MANA_STUB_NONE.tst >> commands.tmp
echo /E:MANA_STUB_NONE execute batch >> commands.tmp
echo /E:MANA_STUB_NONE reports custom management MANA_STUB_NONE_management_report.html >> commands.tmp
